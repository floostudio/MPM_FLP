...
public class GcmMessageHandler extends IntentService {
	...
	public static final String TAG = "GCMNotIntService";
	...
	protected void onHandleIntent(Intent intent) {
		...
		if (!extras.isEmpty()) {
			if (GoogleCloudMessaging.MESSAGE_TYPE_SEND_ERROR
				...
				String firstname = intent.getExtras().getString("username"); // firstname
				String senderid = intent.getExtras().getString("senderid");
				String logintype = intent.getExtras().getString("logintype");
				String sender_lname = "";//intent.getExtras().getString("senderid");
				...
				dbmsg.addContact(new Message(firstname, "", message,
