...
public class AllUsersActivity extends Fragment {
	...
	String myuserid, deviceid, selecteduser;
...
/*
	...
	public class searchfriends extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			response = APIManager.searchfriend(context, myuserid, search);
	...
	public class getfriends extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			response = APIManager.getmyfriends(context, myuserid, deviceid);
	...
	public class getnearbyfriends extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			response = APIManager.getnearbyfriends(context, myuserid,
					deviceid, "", "", "");
...
//				String photourl = DataManager.url+ amList.get(position).getProfilepic();
				String photourl = amList.get(position).getProfilepic();

				ImageUtil.displayImage(holder.img_icon, photourl, null);
				
			}

			if(amList.get(position).getStatus()!=null)
				holder.content.setText(amList.get(position).getStatus());
			else
	...
	public class sendindividualmessage extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			response = APIManager.addasfriend(myuserid, selecteduser,
	...
	public class getuserprofile extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			response = APIManager.getuserprofile(context, myuserid, deviceid,
					selecteduser);
		...
		protected void onPostExecute(String result) {
			...
			if (DataManager.status.equalsIgnoreCase("1")) {
				...
				dbmsg.addContact(new Message(name, "", "Added as Friend",
						myuserid, selecteduser, date, logintype,
