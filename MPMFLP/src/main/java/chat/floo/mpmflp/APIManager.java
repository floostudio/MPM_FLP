	...
	public static boolean searchfriend(Context context, String myuserid,
		...
		try {
			...
			if (resEntity != null) {
				...
				returnString = EntityUtils.toString(resEntity);
				System.out.println("response---" + returnString.toString());
				Log.e("Friend", returnString.toString());
				try {
...
*/
							...
							String logintype = "email";/*new String(array
									.getJSONObject(i).getString("logintype")
									.getBytes("UTF-8"), "UTF-8");*/
				...
				try {
					...
					if (success.equals("1")) {
...

						{
							...
							String firstname = new String(array
									.getJSONObject(i).getString("userid")
									.getBytes("UTF-8"), "UTF-8");
	...
	public static boolean getuserprofile(Context context, String myuserid,
		...
		try {
			...
			if (resEntity != null) {
				...
				returnString = EntityUtils.toString(resEntity);
				System.out.println("APi manager getprofile response---" + returnString.toString());
				try {
...
*/
							...
							String phone =array.getJSONObject(i).getString("handphone");
							String jabatan =array.getJSONObject(i).getString("jabatan");
							String membersince =array.getJSONObject(i).getString("membersince");
							String dealerArea =array.getJSONObject(i).getString("dealer_area");
							String dealerKota =array.getJSONObject(i).getString("dealer_kota");
							String dealerName =array.getJSONObject(i).getString("dealer_name");
							String kodeDealerAHM =array.getJSONObject(i).getString("kode_dealer_ahm");
							String kodeDealerMPM =array.getJSONObject(i).getString("kode_dealer_mpm");
							String status = new String(
									array.getJSONObject(i).getString("status")
											.getBytes("UTF-8"), "UTF-8");
...
*/
							...
							data.setMembersince(membersince);
							data.setDealerArea(dealerArea);
							data.setDealerKota(dealerKota);
							data.setDealerName(dealerName);
							data.setKodeDealerAHM(kodeDealerAHM);
							data.setKodeDealerMPM(kodeDealerMPM);
							//data.setStatus(status);
	...
	public static boolean getnearbyfriends(Context context, String myuserid,
		...
		try {
			...
			if (resEntity != null) {
				...
				returnString = EntityUtils.toString(resEntity);
				System.out.println("response---" + returnString.toString());
				Log.e("searchFriend",returnString.toString());
				try {
...
//							profilepic = URLEncoder.encode(profilepic, "utf-8");
	...
	public static boolean logout(String userid, String deviceid) {
		...
		String url = DataManager.restAPIurl + "user/logoutUser";
		HttpClient client = new DefaultHttpClient();
		HttpPost get = new HttpPost(url);

		List<NameValuePair> paramas = new ArrayList<NameValuePair>();
		paramas.add(new BasicNameValuePair("user_id", userid));
